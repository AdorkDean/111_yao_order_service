...
public class CharSetUtil {
	...
	public static String getSysGBKStr(String strValue) {
		...
		try {
			...
			printLog("getSysGBKStr Exception: " + ex.getMessage());
		}
		return strValue;
	}
	 ...
	 */
	public static String getCharsetConvert(String strIn, String inCharset,
			String outCharset) {
		String strOut = null;
	...
	public static void printLog(String strLog) {
		try {
			...
			System.out.println(new String(strLog.getBytes("GB2312"),
					getFileEncoding()));
		} catch (Exception ex) {
			System.out.println("#########################");
			System.out.println(strLog);
