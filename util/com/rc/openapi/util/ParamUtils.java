...
public class ParamUtils {
	...
	public static String paramUTF8URLEncode(String paramV) {
		try {
			return URLEncoder.encode(paramV, "utf-8");
	...
	public static String getRequestAPIVersion(HttpServletRequest request) {
		return getParameter(request, "v", true);
	}

	public static String getRequestAPIAppKey(HttpServletRequest request) {
		return getParameter(request, "appKey", true);
	}

	public static String getRequestAPITimeStamp(HttpServletRequest request) {
		return getParameter(request, "timestamp", true);
	}

	public static String getRequestAPIFormat(HttpServletRequest request) {
		return getParameter(request, "format", true);
	}

	public static String getRequestAPIMethod(HttpServletRequest request) {
		return getParameter(request, "method", true);
	}

	public static String paramUTF8URLDecode(String paramV) {
		try {
			return URLDecoder.decode(paramV, "utf-8");
		} catch (UnsupportedEncodingException e) {
			e.printStackTrace();
		}
		return paramV;
